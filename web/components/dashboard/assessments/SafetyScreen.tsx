...
/**
 * شاشة السلامة — تظهر بديلًا كاملًا لشاشة النتيجة الرقمية عند تفعيل بروتوكول السلامة، من أي
 * مصدر (البند الحرج في EPDS، أو تجاوز عتبة المجموع الكلي في مقياس الصدمة التالية للولادة).
 * محتواها عام بالكامل بلا إشارة لمقياس بعينه، لذا تُستخدَم كما هي لأي مقياس يُفعِّل السلامة.
 * لا أرقام، لا لغة تشخيصية، فقط دعم هادئ ومسار واضح للمساعدة.
 */
