...
const DAILY_TIPS_SEED = [
  ...
  // ملاحظة: نموذج DailyTip في schema.prisma لا يملك حقل تصنيف (category) ولا is_active —
  // فقط tipNumber/tipTextAr، وهذا يتجاوز نطاق "seed فقط" المسموح به هنا (يتطلب migration).
  // التصنيفات أدناه تنظيمية في الكود المصدري فقط، تُزرع كنصائح عامة إضافية في نفس الجدول

  // الجانب النفسي
  'خبر الحمل قد يثير مشاعر مختلفة بين الفرح والقلق، وهذا أمر طبيعي، فامنحي نفسك الوقت للتكيف مع هذه المرحلة.',
  'خصصي بضع دقائق يومياً للتنفس العميق أو الاسترخاء، فذلك يساعد على التخفيف من التوتر.',
  'عبّري عن مشاعرك وتحدثي مع الأشخاص الذين تثقين بهم، فالدعم الاجتماعي مهم خلال الحمل.',
  'تابعي حالتك المزاجية داخل التطبيق بانتظام، فالمتابعة تساعدك على ملاحظة أي تغيرات نفسية مبكراً.',

  // الجانب الصحي
  'التزمي بمواعيد متابعة الحمل والفحوصات التي يوصي بها الطبيب أو القابلة.',
  'تناولي الأدوية والمكملات الموصوفة لك فقط، ولا تستخدمي أي دواء دون استشارة المختص.',
  'احرصي على شرب كمية كافية من الماء والحصول على قسط كافٍ من النوم والراحة.',
  'مارسي نشاطاً بدنياً مناسباً لحالتك الصحية وبعد موافقة الطبيب أو القابلة.',

  // الجانب الغذائي
  'احرصي على تناول غذاء متوازن ومتنوع يشمل الخضروات والفواكه والحبوب الكاملة والبروتين.',
  'اهتمي بمصادر الحديد والكالسيوم والبروتين خلال مراحل الحمل المختلفة.',
  'تناولي مصادر فيتامين C مع الأطعمة الغنية بالحديد للمساعدة على تحسين امتصاصه.',
  'اشربي الماء بانتظام، وقللي من المشروبات الغنية بالسكر والكافيين.',
